...
fun BackdropEffectScope.lens(
    ...
    lens(
        ...
        chromaticAberrationAmount = if (chromaticAberration) 1f else 0f
    )
}
...
fun BackdropEffectScope.lens(
    ...
    @FloatRange(from = 0.0) refractionAmount: Float,
    depthEffect: Boolean = false,
    @FloatRange(from = 0.0) chromaticAberrationAmount: Float = 0f
) {
    ...
    val effect =
        if (cornerRadii != null) {
            ...
            shader.apply {
                ...
                if (chromaticAberrationAmount > 0f) {
                    setFloatUniform("chromaticAberration", chromaticAberrationAmount)
                }
            }
