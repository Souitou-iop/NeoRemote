...
以下截图来自 iPhone 17 模拟器中的最新版 iOS 控制端，并已连接本机 macOS 接收端。

| 连接引导 | 已连接控制面 |
| --- | --- |
| ![连接引导](screenshots/neoremote-ios-01-onboarding.png) | ![已连接控制面](screenshots/neoremote-ios-03-remote-connected.jpg) |

| 设备页 | 设置页 |
| --- | --- |
| ![设备页](screenshots/neoremote-ios-05-devices.jpg) | ![设置页](screenshots/neoremote-ios-04-settings.jpg) |
